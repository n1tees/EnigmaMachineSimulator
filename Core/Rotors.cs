...
namespace enigma
{
  /// <summary>Ротор Enigma: проводка и поворот, прямое/обратное отображение.</summary>
  class Rotor
  {
    ...
    private void CountUpp() { Count++; }
    private void CountReset() { Count = 0; }
    private bool CountCheck() { return (Count > 25); }
