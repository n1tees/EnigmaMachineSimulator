  ...
  partial class Form2
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.comboBoxThirdRotor.Items.AddRange(new object[] {
            ...
            "Rotor_VI", "Rotor_VII", "Rotor_VIII", "Beta_Rotor", "Gamma_Rotor"});
      ...
      this.comboBoxReflector.Items.AddRange(new object[] {
            "Reflector_B", "Reflector_C", "Reflector_B_Dünn", "Reflector_C_Dünn"});
      ...
      this.comboBoxPlugBoard.Items.AddRange(new object[] { "PB_A", "PB_B", "PB_C" });
