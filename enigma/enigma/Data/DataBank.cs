...
namespace enigma
{
  /// <summary>Текущая конфигурация и справочники проводок роторов/рефлектора/панели.</summary>
  static class Information
  {
    ...
    public static Dictionary<int, int> SearchDictForRef(string s)
    {
      ...
      {
        { 0, 24 }, { 1, 17 }, { 2, 20 }, { 3, 7 }, { 4, 16 }, { 5, 18 }, { 6, 11 },
        { 8, 15 }, { 9, 23 }, { 10, 13 }, { 12, 14 }, { 19, 25 }, { 21, 22 }
      };
      Dictionary<int, int> Reflector_C = new Dictionary<int, int>()
      {
        { 0, 5 }, { 1, 21 }, { 2, 15 }, { 3, 9 }, { 4, 8 }, { 6, 14 }, { 7, 24 },
        { 10, 17 }, { 11, 25 }, { 13, 22 }, { 19, 16 }, { 18, 20 }
      };
      Dictionary<int, int> Reflector_B_Dünn = new Dictionary<int, int>()
      {
        { 0, 4 }, { 1, 13 }, { 2, 10 }, { 3, 16 }, { 5, 20 }, { 6, 24 }, { 7, 22 },
        { 8, 9 }, { 11, 14 }, { 12, 15 }, { 17, 23 }, { 18, 25 }, { 19, 21 }
      };
      Dictionary<int, int> Reflector_C_Dünn = new Dictionary<int, int>()
      {
        { 0, 17 }, { 1, 3 }, { 2, 14 }, { 4, 9 }, { 5, 13 }, { 6, 19 }, { 7, 10 },
        { 8, 21 }, { 11, 12 }, { 15, 22 }, { 16, 25 }, { 18, 23 }, { 20, 24 }
      };
    ...
    public static Dictionary<int, int> SearchDictForPB(string s)
    {
      ...
      {
        {0, 20 }, {1, 17 }, {2, 19 }, {3, 23 }, {4, 25 }, {5, 13 }, {6, 15 },
        {7, 24 }, {8, 22 }, {9, 14 }, {10, 16 }, {11, 21 }, {12, 18 }
      };
      Dictionary<int, int> C = new Dictionary<int, int>()
      {
        {0,2}, {1,18 }, {13,25 }, {19,3 }, {4,15 }, {22,7 }, {5,20 }, {6,14},
        {8,21 }, {9,16 }, {10,23 }, {11,24 }, {17,12 }
      };
